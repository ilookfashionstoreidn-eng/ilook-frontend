...
// We will find from <div className="spk-cutting-groups-wrapper"> until just before {renderSkuSelector
const regex = /<div className="spk-cutting-groups-wrapper">([\s\S]*?)<\/div>\s*<\/div>\s*\{renderSkuSelector/g;

const replacement = `<div className="spk-cutting-groups-wrapper">
